    ...
    <>
      <div className="rw-segment">
        <header className="rw-segment-header">
          <h2 className="rw-heading rw-heading-secondary">WordsBank {wordsBank.id} Detail</h2>
        </header>
        <table className="rw-table">
          <tbody>
            <tr>
              ...
              <th>Language id</th>
              <td>{wordsBank.languageId}</td>
            </tr><tr>
              <th>Source</th>
              <td>{wordsBank.source}</td>
            </tr>
          </tbody>
        </table>
      </div>
